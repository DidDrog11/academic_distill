source(here::here("_posts", "2021-04-23-rodent-trapping-pilot", "scripts", "project_library.R"))

## For pilot study only

trapped_rodents <- readxl::read_xlsx(path = here("_posts", "2021-04-23-rodent-trapping-pilot", "data", "trap_sites_all.xlsx"), sheet = 3) %>%
...
trap_sites <- read_csv(here("_posts", "2021-04-23-rodent-trapping-pilot", "data", "trap_sites.csv")) %>%
