...
![Previously documented Lassa cases in Sierra Leone](images/trapping/lassa_SL.png)
...
![Previously documented Lassa cases near Panguma](images/trapping/lassa_panguma.png)
...
![Lalehun land use map, classified by IUCN categories](images/trapping/lalehun_IUCN.png)

![Seilama land use map, classified by IUCN categories](images/trapping/seilama_IUCN.png)
...
![](images/trapping/proportion_trap_nights.png)

During this visit no traps were set in houses, this will change for future visits.

![](images/trapping/number_trap_nights.png)
...
![](images/trapping/habitat_rodents.png)
...
![](images/trapping/individual_abundance.png)
